        ...
        <div class="grid gap-3 xl:grid-cols-[minmax(0,1.7fr)_180px_150px_auto] xl:items-end">
          ...
          <div>
            ...
            <select class="select-modern w-full" [value]="statusFilter()" (change)="onStatusFilterChange($event)">
              ...
              @for (status of installStatuses; track status) {
        ...
        <div class="table-toolbar-modern">
          <div>
            ...
            <div class="mt-1 text-xs text-white/45">
              Source <span class="font-semibold text-white/65">v_install_queue</span>
            </div>
          </div>
        ...
        @if (!isBrowser()) {
          ...
          @if (isLoading() && rows().length === 0) {
            ...
            <div class="table-region mt-4">
              <div class="table-scroll-region overflow-x-auto">
                    ...
                    @for (item of filteredTableRows(); track item.work_id) {
                      <tr class="cursor-pointer">
                        ...
                        <td>
                          ...
                          <div class="col-secondary text-truncate">
                        ...
                        <td class="col-secondary">
                          {{ item.scheduled_for | date:'MMM d, HH:mm' }}
                        </td>
...
export class InstallationsPageComponent {
  ...
  readonly installStatuses = [...INSTALL_WORK_STATUSES];
  ...
  readonly filteredTableRows = computed<InstallQueueTableRow[]>(() => {
